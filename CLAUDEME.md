...
```
ADVANCEMENT_THRESHOLDS = { qed_compression:0.90, proofpack_gap:0.85, axiom_discovery:0.88, meta_transfer:0.80 }
...
3. Read `~/Desktop/inquiro-standards/META_LESSONS.md` — architecture principles active
